...
def publishAnalytics():
    selectLastWeekInfo = "SELECT startTimeRounded as hour, COUNT(*) as count FROM TestMachines WHERE startTime >= strftime('%s', datetime('now', '-30 minutes')) AND location='new' GROUP BY startTimeRounded;"
